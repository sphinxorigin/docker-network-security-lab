...
sudo iptables -A INPUT -i "$IF_LAN" -j ACCEPT
sudo iptables -A INPUT -i "$IF_SRV" -j ACCEPT
sudo iptables -A INPUT -i "$IF_UP" -p tcp --dport 22 -j ACCEPT
sudo iptables -A INPUT -i "$IF_UP" -p icmp -j ACCEPT
